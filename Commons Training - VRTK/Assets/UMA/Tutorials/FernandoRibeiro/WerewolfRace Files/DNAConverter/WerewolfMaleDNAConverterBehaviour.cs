...
public class WerewolfMaleDNAConverterBehaviour : DnaConverterBehaviour
{
	public WerewolfMaleDNAConverterBehaviour()
    {
		this.ApplyDnaAction = UpdateUMAWerewolfDNABones;
        this.DNAType = typeof(UMADnaHumanoid);
    }
	public static void UpdateUMAWerewolfDNABones(UMAData umaData, UMASkeleton skeleton)
    {
		...
		skeleton.SetPosition(UMASkeleton.StringToHash("Position"),
		  ...
		  new Vector3(
				Mathf.Clamp( ((umaDna.feetSize - 0.5f) * -0.70f) - 0.12f, -0.47f, 0.18f),
				Mathf.Clamp(0, -10, 10),
				Mathf.Clamp(0, -10, 10)));
		...
		skeleton.SetScale(UMASkeleton.StringToHash("LeftFoot"), 
		  new Vector3(
			  Mathf.Clamp(1 + (umaDna.feetSize - 0.5f) * 2.0f, 0.25f, 2.0f),
			  Mathf.Clamp(1 + (umaDna.feetSize - 0.5f) * 2.0f, 0.25f, 2.0f),
			  Mathf.Clamp(1 + (umaDna.feetSize - 0.5f) * 2.0f, 0.25f, 2.0f)));
